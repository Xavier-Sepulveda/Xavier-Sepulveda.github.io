...
I believe this ePortfolio itself follows the outcome of designing, developing, and delivering professional-quality oral, written, and visual communications that are coherent, technically sound, and appropriately adapted to specific audiences and contexts, by being able to explain everything that has been included. This will be used to showcase my ability to work with multiple aspects of computer science, making me a good candidate for a potential client.  I will touch upon some specific courses, and how they helped to give me a better understanding of the following topics.
